            ...
            <div class="container-fluid">
                ...
                <table class="table d-table table-responsive pagination" data-pagecount="2">
                    <thead class="thead-light">
                        <tr>
                            <th class="btn-info text-center" colspan="6" onclick="load_table_data()">Reload Table<i class="fas fa-sync-alt ml-2"></i></th>
                            <th colspan="5">
...
<script>
    ...
    function load_table_data() {
            ...
            $.ajax({
            url: "<?php echo base_url().'commerce/loadcart/1' ?>",
            type: "POST",
            data: dataString,
    ...
    function load_table_paged(page, change, max, show) {
        ...
        url = "<?php echo base_url().'commerce/loadcart/'?>"+page;
